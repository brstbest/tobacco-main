      ...
      <el-col :span="4" v-for="(item) in deviceDataInPage" :key="item.id" :offset="0" style="padding: 20px;">
        <el-card :body-style="{ padding: '0px' }" @click.native="cardClick(item)" class="device-list-item">
          ...
          <div style="padding: 14px;">
            ...
            <el-descriptions :title="postcodeJSON[item.location]+item.device_name" :column='2' :size="small">
                <el-descriptions-item label="状态">
                  <el-tag type="info" size="small">待烤</el-tag>
                </el-descriptions-item>
                <el-descriptions-item label="阶段">{{ '阶段' + Math.floor(Math.random() * 11) }}</el-descriptions-item>
                <el-descriptions-item label="时间">{{ '00:00:00' }}</el-descriptions-item>
                <el-descriptions-item label="预警">7</el-descriptions-item>
            </el-descriptions>
<!--            <el-row>
