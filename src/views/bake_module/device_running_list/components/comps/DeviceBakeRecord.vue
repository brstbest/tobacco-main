...
<script>
  import DateTimeComp from '/src/components/DateTimeComp.vue'
  import AddRecordComp from '../AddRecord'
  ...
  export default{
    ...
    methods: {
      fetchData() {
        ...
        rdata.device_id = this.deviceMsg.device_id
      ...
      searchClick() {
        let rdata = { device_id: this.deviceMsg.device_id }
        let flag = true
