      ...
      <el-col :span="19" class="detail-comp-info-row-right">
        ...
        <el-collapse v-model="activeNames" @change="handleChange" style="padding: 20px;">
          <el-collapse-item name="1">
            <template slot="title" >
              <div style="font-size: large;font-weight: bold;">阶段信息</div>
            </template>
            <el-row :gutter="20">
              <el-col :span="3">阶段1</el-col>
              <el-col :span="7">开始时间：xxxxxxxxxxxx</el-col>
              <el-col :span="7">结束时间：xxxxxxxxxxxx</el-col>
            </el-row>
            <el-progress :text-inside="true" :stroke-width="20" :percentage="100" status="success"></el-progress>
            <el-row :gutter="20">
              <el-col :span="3">阶段2</el-col>
              <el-col :span="7">开始时间：xxxxxxxxxxxx</el-col>
              <el-col :span="7">结束时间：xxxxxxxxxxxx</el-col>
            </el-row>
            <el-progress :text-inside="true" :stroke-width="20" :percentage="100" status="success"></el-progress>
            <el-row :gutter="20">
              <el-col :span="3">阶段3</el-col>
              <el-col :span="7">开始时间：xxxxxxxxxxxx</el-col>
              <el-col :span="7">剩余时间：xxxxxxxxxxxx</el-col>
            </el-row>
            <el-progress :text-inside="true" :stroke-width="20" :percentage="20" status=""></el-progress>
          </el-collapse-item>
          <el-collapse-item name="2">
            <template slot="title" >
              <div style="font-size: large;font-weight: bold;">曲线信息</div>
            </template>
          </el-collapse-item>
          <el-collapse-item name="3">
            <template slot="title" >
              <div style="font-size: large;font-weight: bold;">图像</div>
            </template>
          </el-collapse-item>
          <el-collapse-item name="4">
            <template slot="title" >
              <div style="font-size: large;font-weight: bold;">报警</div>
            </template>
          </el-collapse-item>
          <el-collapse-item name="5">
            <template slot="title" >
              <div style="font-size: large;font-weight: bold;">评分</div>
            </template>
          </el-collapse-item>
        </el-collapse>
      </el-col>
